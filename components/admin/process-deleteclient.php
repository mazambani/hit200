...
if ((isset($_POST['id'])) && (is_numeric($_POST['id']))) { // Form submission.      #1
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($sure == 'Yes') { // Delete the record.
            ...
            mysqli_stmt_prepare($q, 'DELETE FROM clientdetails WHERE id=? LIMIT 1');
...
?>
            <div class="row">
                <div class="col-md-4 m-auto">
                    ...
                    <p>You wont be able to recover the roecord if you click Yes!.</p>

                    <form action="deleteclient.php" method="POST" name="deleteform" ">
