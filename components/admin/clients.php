...
<div class="container">
    ...
    try {
        ...
        $query = "SELECT id, firstname, lastname, gender, email, address1, address2, phone, registrationdate 
            FROM clientdetails
            ORDER BY id ASC";
            ...
            <tbody>';
                ...
                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                    ...
                    '<tr>
                        ...
                        <td><a class="btn btn-danger btn-sm" href="deleteclient.php?id=' . $row['id'] . '">Delete</a></td>
                        </tr>';
                }
                echo
                '</tbody>
