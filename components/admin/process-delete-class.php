...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($sure == 'Yes') { //todo: Delete the record.
            //todo: Make the query:
            //todo: Use prepare statement to remove security problems
            $q = mysqli_stmt_init($dbcon);
            mysqli_stmt_prepare($q, 'DELETE FROM class WHERE id=? LIMIT 1');
            //todo: bind $id to SQL Statement
...
?>
            <div class="row">
                <div class="col-md-4 m-auto">
                    ...
                    <form action="delete-dept.php" method="POST" name="deleteform" process-delete-record.php">
