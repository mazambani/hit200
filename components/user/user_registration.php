        ...
        <div class="row">
            <div class="container mt-md-4">
                <div class="col-md-4  pt-1 m-auto p-md-2">
                    <form action="user_registration.php" method="POST" onsubmit="return checked();">
                        ...
                        <div class="form-group">
                            ...
                            if (isset($_POST['submit_form']) == 'POST') {
                                include('process-registration.php');
                            }
                            ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="submit" value="Register" name="submit_form" class="btn btn-color btn-primary my-2 w-100">
                        </div>
                    </form>
                </div>
            </div>
